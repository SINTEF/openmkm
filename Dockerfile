...
RUN cd /sw/cantera && git checkout openmkmm && scons build optimize=False python_package=n f90_interface=n doxygen_docs=n system_eigen=n system_sundials=n prefix=/sw/cantera_install use_rpath_linkage=False && scons install
